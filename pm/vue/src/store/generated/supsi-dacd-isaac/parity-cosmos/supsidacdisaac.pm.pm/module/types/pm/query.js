...
const baseQueryGetKpiFeaturesRequest = { index: "" };
...
const baseQueryGetKpiFeaturesResponse = {};
export const QueryGetKpiFeaturesResponse = {
    encode(message, writer = Writer.create()) {
        if (message.kpiFeatures !== undefined) {
            KpiFeatures.encode(message.kpiFeatures, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
const baseQueryAllKpiFeaturesRequest = {};
...
const baseQueryAllKpiFeaturesResponse = {};
export const QueryAllKpiFeaturesResponse = {
    ...
    toJSON(message) {
        ...
        if (message.kpiFeatures) {
            obj.kpiFeatures = message.kpiFeatures.map((e) => e ? KpiFeatures.toJSON(e) : undefined);
        }
        else {
            obj.kpiFeatures = [];
        }
...
const baseQueryGetForecastRequest = { index: "" };
...
const baseQueryGetForecastResponse = {};
...
const baseQueryAllForecastRequest = {};
...
const baseQueryAllForecastResponse = {};
export const QueryAllForecastResponse = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.forecast) {
            obj.forecast = message.forecast.map((e) => e ? Forecast.toJSON(e) : undefined);
        }
        else {
            obj.forecast = [];
        }
...
export class QueryClientImpl {
    ...
    KpiFeatures(request) {
        ...
        const promise = this.rpc.request("supsidacdisaac.pm.pm.Query", "KpiFeatures", data);
        return promise.then((data) => QueryGetKpiFeaturesResponse.decode(new Reader(data)));
    }
    KpiFeaturesAll(request) {
        const data = QueryAllKpiFeaturesRequest.encode(request).finish();
        const promise = this.rpc.request("supsidacdisaac.pm.pm.Query", "KpiFeaturesAll", data);
        return promise.then((data) => QueryAllKpiFeaturesResponse.decode(new Reader(data)));
    }
    Forecast(request) {
        const data = QueryGetForecastRequest.encode(request).finish();
        const promise = this.rpc.request("supsidacdisaac.pm.pm.Query", "Forecast", data);
        return promise.then((data) => QueryGetForecastResponse.decode(new Reader(data)));
    }
    ForecastAll(request) {
        const data = QueryAllForecastRequest.encode(request).finish();
        const promise = this.rpc.request("supsidacdisaac.pm.pm.Query", "ForecastAll", data);
        return promise.then((data) => QueryAllForecastResponse.decode(new Reader(data)));
    }
}
