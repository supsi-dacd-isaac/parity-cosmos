...
const baseMarketOperator: object = { idx: "", address: "", creator: "" };

export const MarketOperator = {
  encode(message: MarketOperator, writer: Writer = Writer.create()): Writer {
    if (message.idx !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): MarketOperator {
    ...
    const message = { ...baseMarketOperator } as MarketOperator;
